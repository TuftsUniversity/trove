...
ActiveRecord::Schema.define(version: 20190819133757) do
  ...
  create_table "collection_orders", primary_key: "collection_id", id: :string, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.json "work_order"
  end
