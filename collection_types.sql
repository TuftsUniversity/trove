...
CREATE TABLE `hyrax_collection_types` (
  ...
  `badge_color` varchar(255) COLLATE utf8mb4_general_ci DEFAULT '#663333',
  PRIMARY KEY (`id`),
...
INSERT INTO `hyrax_collection_types` VALUES (1,'User Collection','A User Collection can be created by any user to organize their works.','user_collection',1,1,1,1,0,0,0,0,1,'#705070'),(2,'Admin Set','An aggregation of works that is intended to help with administrative control. Admin Sets provide a way of defining behaviors and policies around a set of works.','admin_set',0,0,1,0,1,1,1,1,0,'#405060'),(3,'Trove Student Collection','Student collections for Trove.','trove_user_collection',1,1,1,1,0,0,0,1,1,'#663333'),(4,'Trove Course Collection','Course Collections for Trove','trove_course_collection',1,1,1,1,0,0,0,1,1,'#663333');
...
-- Dump completed on 2019-06-07 16:25:59
